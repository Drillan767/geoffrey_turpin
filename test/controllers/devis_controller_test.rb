...
class DevisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create devi" do
    assert_difference('Devi.count') do
      post devis_url, params: { devi: { email: @devi.email, nom: @devi.nom, prenom: @devi.prenom, telephone: @devi.telephone } }
    end
  ...
  test "should update devi" do
    patch devi_url(@devi), params: { devi: { email: @devi.email, nom: @devi.nom, prenom: @devi.prenom, telephone: @devi.telephone } }
