...
class SpecsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spec" do
    assert_difference('Spec.count') do
      post specs_url, params: { spec: { deadline: @spec.deadline, description: @spec.description, duree: @spec.duree, genre: @spec.genre, image: @spec.image } }
    end
  ...
  test "should update spec" do
    patch spec_url(@spec), params: { spec: { deadline: @spec.deadline, description: @spec.description, duree: @spec.duree, genre: @spec.genre, image: @spec.image } }
